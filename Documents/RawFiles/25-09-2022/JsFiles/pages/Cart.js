                    ...
                    <div className="block">
                        ...
                        <form method="post">
                            ...
                            <tbody>
                                {cartList.map((item) => {
                                    const item1=item
                                    console.log("Mapp-"+item1.apparelId)
                                    return (
                                        <tr className="">
                                            ...
                                            <td className="">
                                            <input type="button" onClick={()=>{handlerRemove(item1)}} value="Remove"></input>
                                                {/* <button className="btn btn-danger btn-sm"  onClick={()=>{handlerRemove(item1)}}>Remove</button> */}
                                            </td>
                                        </tr>
                                    )
                                })}
                            ...
                            <Link to="/checkout2" className="btn btn-main pull-right">Checkout</Link>
                        </form>
                        </div>
                    </div>
                    </div>
