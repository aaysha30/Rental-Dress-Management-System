						...
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										<li class="dropdown-header">For Him</li>
										<li role="separator" class="divider"></li>
										<li><a href="contact.html">Sherwani</a></li>
										<li><a href="about.html">Tuxedo</a></li>
										<li><a href="404.html">Kurta Pyjama</a></li>
									</ul>
								</div>
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										<li class="dropdown-header">For Her</li>
										<li role="separator" class="divider"></li>
										<li><a href="contact.html">Lehenga</a></li>
										<li><a href="about.html">Gowns</a></li>
										<li><a href="404.html">Indo-Western</a></li>
									</ul>
								</div>
