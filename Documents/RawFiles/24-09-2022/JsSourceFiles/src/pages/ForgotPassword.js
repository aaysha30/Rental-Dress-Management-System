...
//Vendor Forgot Password
  ...
  return (
    <div>
        <section className="forgot-password-page account">
            <div className="container">
                ...
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <form className="text-left clearfix">
                        ...
                        <button type="submit" className="btn btn-main text-center" onClick={handleDetails}>reset password For Customer</button>
