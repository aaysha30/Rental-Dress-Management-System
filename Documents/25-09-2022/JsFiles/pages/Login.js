            ...
            <div className="col-md-4 col-xs-12 col-sm-4">
                ...
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <form className="text-left clearfix" action="/">
                        ...
                        <button className="btn btn-main text-center" onClick={handleCustomer} >Login As Customer</button>
                        &nbsp;&nbsp;&nbsp;
                       
                            <button className="btn btn-main text-center " onClick={handleVendor} >Login As Vendor</button>
                        </div>   
