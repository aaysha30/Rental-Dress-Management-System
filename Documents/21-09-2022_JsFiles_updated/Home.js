...
export default function Home() {
    ...
    const user=useSelector(state=>{ return state.uname});
    const cartList=useSelector((state1)=>{return console.log("Home Page->Cart List :->"+state1.cartItems.map((e)=>{console.log(e.description)}))});
...
naviagte('/')
    ...
    <React.Fragment>
       <section className="top-header">
                            ...
                            <ul className="top-menu text-right list-inline">
                                ...
                                <li className="dropdown search dropdown-slide">
                                    <Link to="#!" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><i
                                            className="tf-ion-ios-search-strong"></i> Hello {user}</Link>
            ...
            {(user=="") &&<button onClick={HandlerLogIn}>LogIn</button>}       
                                        ...
                                        <div className="dropdown-menu">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12 col-md-6 mb-sm-3">
                                                  ...
                                                  <li><Link to="/cartRemove">CartRemoveProduct</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            {/* <!-- / .row --> */}
